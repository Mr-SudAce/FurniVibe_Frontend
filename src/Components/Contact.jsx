...
const Contact = () => {
    return (
        <>
            ...
            <section className="relative h-screen w-full bg-gray-100 overflow-hidden">
                ...
                <div className="flex items-center justify-center h-full relative z-10">
                    <div className="bg-white bg-opacity-90 rounded-2xl shadow-2xl p-10 flex flex-col items-center max-w-md w-full backdrop-blur-md lg:ml-auto md:ml-auto m-10">
