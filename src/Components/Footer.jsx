      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-20">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <p className="text-gray-500 font-light leading-relaxed max-w-sm text-sm italic font-serif">
              &quot;
              {detail?.site_tag ||
                "Crafting elegance for your home, one piece at a time."}
              &quot;
            </p>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <nav className="flex flex-col gap-4 text-sm font-bold text-gray-600 uppercase tracking-widest">
              ...
              >
                <span className="w-0 group-hover:w-4 h-[1px] bg-orange-500 transition-all"></span>{" "}
                Home
              </a>
              <a
                href="/shop"
        ...
        <div className="pt-10 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">
            ...
            <span className="text-gray-900">
              {detail?.site_name || "Om Sai Furniture"}
            </span>
            . All Rights Reserved.
          </p>
